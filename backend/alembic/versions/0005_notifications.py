...
def upgrade() -> None:
    ...
    postgresql.ENUM("push", "sms", name="reminder_channel").create(op.get_bind(), checkfirst=True)
    postgresql.ENUM("sent", "failed", "skipped", name="reminder_status").create(op.get_bind(), checkfirst=True)
